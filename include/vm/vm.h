...
struct frame {
	void *kva; // kernal virtual address of physical memory
	void *uva; // user virtual address of virtual memory
	struct page *page;
    struct thread *t;
...
bool spt_less_func (const struct hash_elem *a_, const struct hash_elem *b_, void *aux);
